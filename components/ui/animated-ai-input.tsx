...
export function AI_Prompt({ onSubmit, isLoading = false, placeholder = "Describe who you're shopping for..." }: AI_PromptProps) {
    const [value, setValue] = useState("");
    const { textareaRef, adjustHeight } = useAutoResizeTextarea({
        minHeight: 72,
        maxHeight: 300,
    });
    const [selectedModel, setSelectedModel] = useState("Gift AI Pro");
    ...
    const MODEL_ICONS: Record<string, React.ReactNode> = {
        ...
        "Gift AI Standard": (
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M20 7L12 3L4 7L12 11L20 7Z" fill="currentColor"/>
                <path d="M4 12L12 16L20 12" stroke="currentColor" strokeWidth="2" fill="none"/>
                <path d="M4 17L12 21L20 17" stroke="currentColor" strokeWidth="2" fill="none"/>
            </svg>
        ),
        "Gift AI Quick": (
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
